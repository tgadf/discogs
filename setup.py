...
setup(
  name = 'discogs',
  py_modules = ['discogsBase', 'discogsUtils', 'collection', 'multiArtist', 'artist', 'artists', 'album', 'albums', 'masterdb', 'mainDB'],
  version = '0.0.1',
  ...
  install_requires=['utils==0.0.1', 'jupyter_contrib_nbextensions'],
