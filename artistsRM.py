...
class artistsRM():
    def __init__(self, discog, basedir=None):
        self.disc = discog
        self.name = "artists-rateyourmusic"
        
        self.artist = artistRM()
        ...
        self.discogsUtils        = rateyourmusicUtils()
    ...
    ################################################################################
    def searchRateYourMusicForArtist(self, artist, debug=True, sleeptime=2):
